//nolint:paralleltest,maintidx,ireturn,dupl,contextcheck
package e2e_test
...
func createContainer(ctx context.Context) (testcontainers.Container, string, error) {
	...
	return container, fmt.Sprintf("user=%s dbname=%s password=%s host=%s port=%s sslmode=disable",
